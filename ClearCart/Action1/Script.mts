...
Browser("Edgewords Shop – e-commerce").Page("Cart – Edgewords Shop").WebElement("Your cart is currently").Check CheckPoint("Your cart is currently full.") @@ script infofile_;_ZIP::ssf7.xml_;_
